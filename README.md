...
რეალური ელფოსტის ჩასართავად დაამატე ოთხი ცვლადი:

```
SMTP_HOST=smtp-relay.brevo.com
SMTP_PORT=587
SMTP_USER=<შენი SMTP მომხმარებელი>
SMTP_PASS=<შენი SMTP გასაღები>
MAIL_FROM=Cyber <noreply@example.com>
```

ამის შემდეგ კოდი ავტომატურად წერილით გაიგზავნება. `SMTP_HOST`-ის გარეშე
სისტემა კონსოლზე გადადის — **კოდის ცვლილება არ არის საჭირო**.

თუ გაგზავნა ჩავარდა (არასწორი გასაღები, ლიმიტი), მოთხოვნა მაინც `200`-ს
აბრუნებს და კოდი ლოგში იბეჭდება — მომხმარებელი არ ბლოკდება.
